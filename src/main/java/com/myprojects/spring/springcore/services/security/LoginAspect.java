...
public class LoginAspect {
    ...
    @Before("com.myprojects.spring.springcore.services.security.LoginAspect.doAuthenticate() && args(authentication)")
    ...
    @AfterReturning(value = "com.myprojects.spring.springcore.services.security.LoginAspect.doAuthenticate()",
    ...
    @AfterThrowing("com.myprojects.spring.springcore.services.security.LoginAspect.doAuthenticate() && args(authentication)")
